...
1. Clone o repositório com o comando: `git clone git@github.com:aimemartins/project-trybers-and-dragons.git`
2. Entre na pasta do repositório que você acabou de clonar: `cd project-trybers-and-dragons`
